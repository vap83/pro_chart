...
function ProChart_InitCommunity(b){function e(b){var d=a.chart.TakeSnapshot();b=b.replace(/%srs%/g,d);$("#chart-dialog").html(b);$("#chart-dialog").find("#snap-shot-image").bind("load",function(){$("#chart-dialog").dialog("option","position",{my:"center",at:"center",of:window})});l();$("#chart-dialog").dialog("open")}function m(b,d){function c(a){$(a).find(".spectrum-color").each(function(){$(this).spectrum("destroy")})}function e(a){$(a).find(".ui-dialog-buttonset").prepend('<button class="chart-button adv-buttons eye-orange " type="button" title="" ></button>').on("click",
function(){var a=$(".chart-ui-dialog.community-dialog").css("opacity"),a=1==a?.5:1,b=1==a?"":2;$(".chart-ui-dialog.community-dialog").css("opacity",a);$(this).css("opacity",b)})}var f="Close",g=d,h="";"undefined"!=typeof a.localizationobj&&(f=a.localizationobj.gui.returnLocalizationString("dialogs.common.button-close","Close"),g=a.localizationobj.gui.returnLocalizationString("dialogs.community.title",d));"undefined"!=typeof a.init.TemplateName&&(h=a.init.TemplateName);var k="";"rtl"==a.localizationobj.gui.returnCurrentLanguage().direction&&
(k="dir-rtl");$('<div id="chart-dialog" title="'+g+'"></div>').insertAfter("body");$("#chart-dialog").dialog({dialogClass:"chart-ui-dialog community-dialog "+h+" "+k,draggable:!0,autoOpen:!1,resizable:!1,closeOnEscape:!0,width:"auto",modal:!0,open:function(b,d){e($(this).parent());$(".ui-widget-overlay").last().addClass("chart-ui-widget-overlay");if(a.api.props){var c=a.api.props.chart.gui.layout.zindex_dialog;$(".chart-ui-widget-overlay").css({"z-index":c});$(".chart-ui-dialog").css({"z-index":c})}$(".ui-widget-overlay").bind("click",
function(){$("#chart-dialog").dialog("close")});"undefined"!=typeof a.preloadobj&&a.preloadobj.endPreload()},close:function(a,b){c($(this).parent());$("#chart-dialog").remove();$("div.chart-ui-dialog.systems-dialog  adv-buttons.eye-orange").off().remove();$("div.chart-ui-dialog.systems-dialog").off().remove();$(this).off().empty().remove()},buttons:[{id:"btn-dialogs-close",text:f,click:function(){$(this).dialog("close")}}]})}function l(){$(".properties-tabs").delegate("a","click",function(){var a=
$(this).index();$(".main-properties").each(function(){$(this).css("display","none")});$(".properties-tabs-label").each(function(){$(this).removeClass("active")});$(".main-properties").eq(a).css("display","block");$(this).addClass("active")})}var a=b;a.api.debug.getLogger("prochart.gui.community");b={};a.community=b;var c="";b.gui={viewScreenShot:function(){"undefined"!=typeof a.preloadobj&&a.preloadobj.startPreload();c="Chart snapshot";m("test",c);e(a.patterns.community.form)}};b.init={};return b}
;
...
function(a){if(27==a.which)B();else{var h=$(this).val();null!=C&&clearTimeout(C);C=setTimeout(function(){var a=h;5<=c.api.debug.level&&console.log("Run search");"undefined"==typeof a&&(a="");null!=b.pmain&&b.pmain.html("");null!=b.ptab&&b.ptab.html("");$(f.parent).find(".chart-header-search-output").css("display","block");q.text=a;A({guiparent:"header"},q.exchange,q.market,q.country,q.text,q.top,q.pageindex);clearTimeout(C)},c.apiinit.searchDelay)}})}function R(){$(f.parent).find(".symbol-title,.search-symbolics").bind("click",
function(a){var c=$(f.parent).find(".chart-header-search");0<c.length&&("block"==c.css("display")?B():H(a))})}function H(a){$(f.parent).find(".symbol-title").html();$(f.parent).find(".chart-header-search").css("display","block");$(f.parent).find(".chart-header-search-input-text").select().focus().addClass("search-open");"undefined"!=typeof a&&a.stopPropagation();P();if($.prochartcache.get("body"))$.prochartcache.get("body").on("click",B);Q()}function A(a,h,b,e,g,k,d){if("undefined"!=typeof c.chart.symbols){if("undefined"!=
typeof c.preloadobj){var l=$(f.parent).find(".chart-search-preload");c.preloadobj.startPreloadinobject(l,null,"small")}c.chart.symbols.FindSymbols(a,h,b,e,g,k,d)}}function S(a){"undefined"!=typeof c.preloadobj&&"undefined"!=typeof a.html()&&c.preloadobj.endPreloadinobject(a)}function I(a){if("undefined"!=typeof y)for(var c=0;c<y.length;c++)if(y[c].id==a)return y[c];return null}function r(a,h){if("undefined"!=typeof c.localizationobj)return c.localizationobj.gui.returnLocalizationString(a,h)}function J(a){switch(c.api.timeframes.getTimeframeView()){case "icon":var h=
r("menu.timescale.1min","1 minute");switch(a){case "tick":case "Tick":case "TICK":case "1T":case "1t":h=r("menu.timescale.1T","tick");break;case "1M":case "1m":h=r("menu.timescale.1M","1 minute");break;case "5M":case "5m":h=r("menu.timescale.5M","5 minute");break;case "10M":case "10m":h=r("menu.timescale.10M","10 minutes");break;case "15M":case "15m":h=r("menu.timescale.15M","15 minutes");break;case "30M":case "30m":h=r("menu.timescale.30M","30 minutes");break;case "60M":case "60m":h=r("menu.timescale.60M",
"Hourly");break;case "2H":case "2h":h=r("menu.timescale.2H",'2 Hours"');break;case "4H":case "4h":h=r("menu.timescale.4H","4 Hours");break;case "6H":case "6h":h=r("menu.timescale.6H","6 Hours");break;case "8H":case "8h":h=r("menu.timescale.8H","8 Hours");break;case "10H":case "10h":h=r("menu.timescale.10H","10 Hours");break;case "12H":case "12h":h=r("menu.timescale.12H","12 Hours");break;case "14H":case "14h":h=r("menu.timescale.14H","14 Hours");break;case "1D":case "1d":h=r("menu.timescale.1D","Daily");
break;case "1W":case "1w":h=r("menu.timescale.1W","Weekly");break;case "1MON":case "1mon":case "1N":case "1n":h=r("menu.timescale.1N","Monthly");break;case "1Q":case "1q":case "3N":case "3n":h=r("menu.timescale.3N","3 Months");break;case "6MON":case "6mon":case "6N":case "6n":h=r("menu.timescale.6N","6 Months");break;case "1Y":case "1y":h=r("menu.timescale.1Y","Year")}return h;case "text":return h=c.api.timeframes.getCaptionbyID(a),r("menu.timescale."+a,h)}return""}function K(a){return"undefined"!=
typeof a&&null!=a?"menu.timescale."+a.toUpperCase():"menu.timescale.5M"}function x(a,c){var b="",b="undefined"==typeof a.position?b+"position :absolute;":b+"position :"+a.position+"; ",e="px";"undefined"!=typeof c&&null!=c&&(e=c);"undefined"!=typeof a.display&&(b=b+"display :"+a.display+";");"undefined"!=typeof a.left&&(b=b+"left :"+t(a.left,e)+"; ");"undefined"!=typeof a.right&&(b=b+"right :"+t(a.right,e)+"; ");"undefined"!=typeof a.top&&(b=b+"top :"+t(a.top,e)+"; ");"undefined"!=typeof a.bottom&&
(b=b+"bottom :"+t(a.bottom,e)+"; ");"undefined"!=typeof a.width&&(b=b+"width :"+t(a.width,e)+"; ");"undefined"!=typeof a.height&&(b=b+"height :"+t(a.height,e)+"; ");"undefined"!=typeof a.view&&!0!=a.view&&(b+="display : none; ");return 0<b.length?'style="'+b+'"':null}function t(a,c,b){return"auto"==a.toString().toLowerCase()||"inherit"==a.toString().toLowerCase()?a:"undefined"!=typeof b?a+b+c:a+c}function s(a){return"undefined"==typeof a||null==a}var c=M,f={};c.header=f;var L=0,y=[],v=/=""/g;c.api.debug.getLogger("prochart.gui.header");
var C=null,b={pmain:null,ptab:null,p:null,parpreload:null,pfilter:[{markets:null},{exchanges:null},{countries:null}],pfilterlabel:[{markets:null},{exchanges:null},{countries:null}],templates:[]},q={text:"",market:"",exchange:"",country:"",pageindex:0,top:15};f.gui={viewHeader:function(a){f.parent=a;for(var h=c.currenlayout.headers,z=0;z<h.length;z++){var e=h[z],g=c.commonutils.func.returnShortUniqID(),k="",d="";e.guiid=g;"undefined"!=typeof e.location&&(k=k+" loc-"+e.location);d=g;"undefined"!=typeof e.id&&
(d=e.id);g=c.patterns.header.containter.replace(v,"").replace(/%css%/g,k).replace(/%tid%/g,d).replace(/%id%/g,g);d="";for(k=0;k<e.items.length;k++)switch(d=e.items[k],d.type){case "searchbutton":var l=c.commonutils.func.returnShortUniqID();d.guiid=l;var p=c.api.layout.getbuttonStyle(),p=c.patterns.header.searchbutton.replace(v,"").replace(/%icon-source%/g,p.icon_source).replace(/%font-icon%/g,""==p.icon_prefix?"":p.icon_prefix+"search-symbolics").replace(/%id%/g,l).replace(/%style%/g,x(d.possition));
d.fns=[];d.fns.push({prop:"view",actions:["$('#"+l+"').css('display',%value%?'block':'none')"]});d.possition.fns=[];for(var m="right left width height top bottom".split(" "),n=0;n<m.length;n++)d.possition.fns.push({prop:m[n],actions:["$('#"+l+"').css('"+m[n]+"',isNaN('%value%')?'auto': '%value%' + 'px' )"]});d={header:p};g=g.replace(/%html%/g,d.header+"%html%");break;case "symboltitle":l=c.commonutils.func.returnShortUniqID();d.guiid=l;p=c.patterns.header.symboltitle.replace(v,"").replace(/%id%/g,
l).replace(/%style%/g,x(d.possition));d.fns=[];d.fns.push({prop:"view",actions:["$('#"+l+"').css('display',%value%?'block':'none')"]});d.possition.fns=[];m="right left width height top bottom".split(" ");for(n=0;n<m.length;n++)d.possition.fns.push({prop:m[n],actions:["$('#"+l+"').css('"+m[n]+"',isNaN('%value%')?'auto': '%value%' + 'px' )"]});d={header:p};g=g.replace(/%html%/g,d.header+"%html%");break;case "searchsymbol":l=c.commonutils.func.returnShortUniqID();d.guiid=l;p=c.patterns.header.symbolsearch.replace(v,
"").replace(/%id%/g,l).replace(/%style%/g,x(d.possition));d.fns=[];d.fns.push({prop:"view",actions:["$('#"+l+"').css('display',%value%?'block':'none')"]});d.possition.fns=[];m="right left width height top bottom".split(" ");for(n=0;n<m.length;n++)d.possition.fns.push({prop:m[n],actions:["$('#"+l+"').css('"+m[n]+"',isNaN('%value%')?'auto': '%value%' + 'px' )"]});d={header:p};g=g.replace(/%html%/g,d.header+"%html%");break;case "timeframe":l=c.commonutils.func.returnShortUniqID();d.guiid=l;p=c.patterns.header.timeframe.replace(v,
"").replace(/%id%/g,l).replace(/%style%/g,x(d.possition));d.fns=[];d.fns.push({prop:"view",actions:["$('#"+l+"').css('display',%value%?'block':'none')"]});d.possition.fns=[];m="right left width height top bottom".split(" ");for(n=0;n<m.length;n++)d.possition.fns.push({prop:m[n],actions:["$('#"+l+"').css('"+m[n]+"',isNaN('%value%')?'auto': '%value%' + 'px' )"]});d={header:p};g=g.replace(/%html%/g,d.header+"%html%");break;case "communic":l=c.commonutils.func.returnShortUniqID();d.guiid=l;p=c.api.layout.getbuttonStyle();
p=c.patterns.header.communic.replace(v,"").replace(/%id%/g,l).replace(/%icon-source%/g,p.icon_source).replace(/%font-icon%/g,""==p.icon_prefix?"":p.icon_prefix+"header-communic").replace(/%style%/g,x(d.possition));d.fns=[];d.fns.push({prop:"view",actions:["$('#"+l+"').css('display',%value%?'block':'none')"]});d.possition.fns=[];m="right left width height top bottom".split(" ");for(n=0;n<m.length;n++)d.possition.fns.push({prop:m[n],actions:["$('#"+l+"').css('"+m[n]+"',isNaN('%value%')?'auto': '%value%' + 'px' )"]});
d={header:p};g=g.replace(/%html%/g,d.header+"%html%");break;case "lastupdate":l=c.commonutils.func.returnShortUniqID();d.guiid=l;p=c.patterns.header.lastupdate.replace(v,"").replace(/%id%/g,l).replace(/%style%/g,x(d.possition));d.fns=[];d.fns.push({prop:"view",actions:["$('#"+l+"').css('display',%value%?'block':'none')"]});d.possition.fns=[];m="right left width height top bottom".split(" ");for(n=0;n<m.length;n++)d.possition.fns.push({prop:m[n],actions:["$('#"+l+"').css('"+m[n]+"',isNaN('%value%')?'auto': '%value%' + 'px' )"]});
d={header:p};g=g.replace(/%html%/g,d.header+"%html%");break;case "htmlcontainer":l=c.commonutils.func.returnShortUniqID();"undefined"!=typeof d.id&&""!=d.id&&(l=d.id);d.guiid=l;"undefined"==typeof d.content&&(d.content="");p="";"undefined"!=typeof d.css&&(p=d.css);p=c.patterns.header.htmlcontainer.replace(v,"").replace(/%html%/g,d.content).replace(/%id%/g,l).replace(/%css%/g,p).replace(/%style%/g,x(d.possition));d.fns=[];d.fns.push({prop:"view",actions:["$('#"+l+"').css('display',%value%?'block':'none')"]});
d.fns.push({prop:"content",actions:["$('#"+l+"').html('%value%')"]});d.possition.fns=[];m="right left width height top bottom".split(" ");for(n=0;n<m.length;n++)d.possition.fns.push({prop:m[n],actions:["$('#"+l+"').css('"+m[n]+"',isNaN('%value%')?'auto': '%value%' + 'px' )"]});d={header:p};g=g.replace(/%html%/g,d.header+"%html%");break;case "toolbar":l=c.commonutils.func.returnShortUniqID();d.guiid=l;p=c.patterns.header.toolbar.replace(v,"").replace(/%id%/g,l).replace(/%style%/g,x(d.possition));d.fns=
[];d.fns.push({prop:"view",actions:["$('#"+l+"').css('display',%value%?'block':'none')"]});d.possition.fns=[];m="right left width height top bottom".split(" ");for(n=0;n<m.length;n++)d.possition.fns.push({prop:m[n],actions:["$('#"+l+"').css('"+m[n]+"',isNaN('%value%')?'auto': '%value%' + 'px' )"]});d={header:p};g=g.replace(/%html%/g,d.header+"%html%")}g=g.replace(/%html%/g,"");$.prochartcache.get(f.parent,"#"+e.parent)&&$.prochartcache.get(f.parent,"#"+e.parent).append(g);for(g=0;g<e.items.length;g++)switch(k=
e.items[g],k.type){case "toolbar":if("undefined"!=typeof c.currenlayout.toolbars&&null!=c.currenlayout.toolbars)for(d=0;d<c.currenlayout.toolbars.length;d++)if(l=c.currenlayout.toolbars[d],l.id==k.id){l.parent=k.guiid;break}}}h=J(c.chart.TimeFrame);z=K(c.chart.TimeFrame);e=c.chart.Symbol;"undefined"!=c.chart.SymbolName&&null!=c.chart.SymbolName&&(e=c.chart.SymbolName);$(f.parent).find(".symbol-title").html(e);$(f.parent).find(".header-timeframe").attr("data-localize",z).html(h);"undefined"!=typeof c.localizationobj&&
c.localizationobj.gui.updateFromDataLang(a);R();b.pmain=$.prochartcache.get(f.parent,".search-main-properties-tabs");b.ptab=$.prochartcache.get(f.parent,".search-properties-tabs-labels");b.p=$.prochartcache.get(f.parent,".chart-header-search-output");b.parpreload=$.prochartcache.get(f.parent,".chart-search-preload");if(a=$.prochartcache.get(f.parent,'.search-properties-filter[idx="markets"] ul'))b.pfilter.markets=a;if(a=$.prochartcache.get(f.parent,'.search-properties-filter[idx="markets"] a.action-change-value'))b.pfilterlabel.markets=
a;if(a=$.prochartcache.get(f.parent,'.search-properties-filter[idx="exchanges"] ul'))b.pfilter.exchanges=a;if(a=$.prochartcache.get(f.parent,'.search-properties-filter[idx="exchanges"] a.action-change-value'))b.pfilterlabel.exchanges=a;if(a=$.prochartcache.get(f.parent,'.search-properties-filter[idx="countries"] ul'))b.pfilter.countries=a;if(a=$.prochartcache.get(f.parent,'.search-properties-filter[idx="countries"] a.action-change-value'))b.pfilterlabel.countries=a;(a=$.prochartcache.get(f.parent,
"#template-search-output-list"))?(b.templates.push(a.html()),a.remove()):b.templates.push(null);(a=$.prochartcache.get(f.parent,"#template-search-properties-tabs-label"))?(b.templates.push(a.html()),a.remove()):b.templates.push(null);(a=$.prochartcache.get(f.parent,"#template-search-main-properties"))?(b.templates.push(a.html()),a.remove()):b.templates.push(null);(a=$.prochartcache.get(f.parent,"#template-search-notfound"))?(b.templates.push(a.html()),a.remove()):b.templates.push(null);(a=$.prochartcache.get(f.parent,
"#template-search-properties-filter-values"))?(b.templates.push(a.html()),a.remove()):b.templates.push(null);E();F();G();N()},onChangeSymbol:function(a,c){"undefined"!=typeof c&&null!=c&&$.prochartcache.get(f.parent,".symbol-title")&&$.prochartcache.get(f.parent,".symbol-title").html(c.name)},onChangeTimeframe:function(a,c){if("undefined"!=typeof f.parent){var b=J(c),e=K(c);$.prochartcache.get(f.parent,".header-timeframe")&&$.prochartcache.get(f.parent,".header-timeframe").attr("data-localize",e).html(b)}},
onLastUpdateChange:function(a,c){$.prochartcache.get(f.parent,".header-lastupdate")&&$.prochartcache.get(f.parent,".header-lastupdate").html(c)},onCommunication:function(a,c){switch(c){case !0:$.prochartcache.get(f.parent,".header-communic")&&$.prochartcache.get(f.parent,".header-communic").addClass("ComOn").removeClass("ComOff");break;case !1:$.prochartcache.get(f.parent,".header-communic")&&$.prochartcache.get(f.parent,".header-communic").addClass("ComOff").removeClass("ComOn")}},changeLocalization:function(){},
findSymbols:A,callbackonFindSymbols:function(a,h,q){5<=c.api.debug.level&&console.log(q);null!=b.pmain&&b.pmain.html("");null!=b.ptab&&b.ptab.html("");u("markets");u("countries");u("exchanges");a=q.data;y=[];q.data.forEach(function(a){y=y.concat(a.symbols)});var e=0,g=c.api.layout.getbuttonStyle();a.forEach(function(a){var d=a.categoryId,h=a.categoryLabel,f=a.categoryDescription,m=e==L?"active":"";e+=1;h=c.patterns.header.search_properties_tabs_label.replace(/%groupactive%/g,m).replace(/%groupid%/g,
d).replace(/%groupname%/g,h).replace(/%groupnesc%/g,f);b.ptab.append(h);m=c.patterns.header.search_main_properties.replace(/%groupid%/g,d).replace(/%groupactive%/g,m);b.pmain.append(m);d=$(b.pmain).find('[idx="'+d+'"] .search-output-list');0==a.symbols.length&&"undefined"!=typeof d.html()&&d.append(c.patterns.header.search_notfound);for(m=0;m<a.symbols.length;m++){var h=a.symbols[m],f=h.id,n=h.description,q=h.name,f=c.patterns.header.search_output_list.replace(/%icon-source%/g,g.icon_source).replace(/%itemid%/g,
f).replace(/%caption%/g,n).replace(/%name%/g,q);h="undefined"!=typeof c.init.majors&&null!=c.init.gui.majorsReturn(h.id)?!0:!1;f=h?f.replace(/%status-favorite%/g,g.icon_prefix+"startenabled-icon"):f.replace(/%status-favorite%/g,g.icon_prefix+"stardisabled-icon");"undefined"!=typeof d.html()&&d.append(f)}});$(b.ptab).find(".search-properties-tabs-label").off("click").on("click",function(a){a=$(this).parents(".chart-header-search-output");var c=$(a).find("a.search-properties-tabs-label").index(this);
L=c;$(a).find(".search-main-properties").each(function(){$(this).removeClass("active")});$(a).find(".search-properties-tabs-label").each(function(){$(this).removeClass("active")});$(a).find(".search-main-properties").eq(c).addClass("active");$(this).addClass("active")});$(b.pmain).find("li > a").off("click").off("click").on("click",function(){var a=$(this).parent().attr("idx");"undefined"!=typeof c.chart.ChangeSymbol&&(B(),a=I(a),5<=c.api.debug.level&&console.log(a),c.chart.ChangeSymbol(a))});$(b.pmain).find("li button.star-button").off("click").on("click",
function(a){a.stopPropagation();a=$(this).parent().attr("idx");var b=c.api.layout.getbuttonStyle();$(this).hasClass(b.icon_prefix+"stardisabled-icon")?($(this).addClass(b.icon_prefix+"startenabled-icon").removeClass(b.icon_prefix+"stardisabled-icon"),a=I(a),"undefined"!=typeof c.init.majors&&c.init.gui.majorsAddObj(a),"undefined"!=typeof c.menuobj&&c.menuobj.gui.updateMajorFavorites()):($(this).removeClass(b.icon_prefix+"startenabled-icon").addClass(b.icon_prefix+"stardisabled-icon"),"undefined"!=
typeof c.init.majors&&(c.init.gui.majorsRemove(a),"undefined"!=typeof c.menuobj&&c.menuobj.gui.updateMajorFavorites()))});$(b.pmain).find("li").off("click").on("click",function(){var a=$(this).attr("n");"undefined"!=typeof a&&$(f.parent).find(".chart-header-search-input-text").val(a)});S(b.parpreload);return null},marketsUpdate:E,exchangesUpdate:F,countriesUpdate:G,openSearch:H};f.api={removeItem:function(a,b){a=s(a)?"header1":a;if("undefined"==typeof b)return!1;if("undefined"!=typeof c.currenlayout.headers)for(var f=
c.currenlayout.headers,e=0;e<f.length;e++){var g=f[e];if(g.id==a)for(var k=0;k<g.items.length;k++)if(g.items[k].type==b)return!0}return!1},addItem:function(a,b,f){a=s(a)?"header1":a;if("undefined"==typeof b.type)return!1;"undefined"!=typeof f&&(f=!1);if("undefined"!=typeof c.currenlayout.headers)for(var e=c.currenlayout.headers,g=0;g<e.length;g++){var k=e[g];if(k.id==a){for(a=0;a<k.items.length;a++)if(k.items[a].type==b.type){if(!1==f)return!1;k.items.slice(a,1);break}k.items.push(b);return!0}}return!1},
updateItem:function(a,b){s(a);return!1},changeItemPossition:function(){},viewItem:function(){},addHtmlContainer:function(a,b,f,e,g,k,d,l,p,m){a=s(a)?"header1":a;b=s(b)?c.commonutils.func.returnShortUniqID():b;f=s(f)?"":f;s(e);g=s(g)?"auto":g;k=s(k)?"auto":k;d=s(d)?"auto":d;l=s(l)?"auto":l;p=s(p)?"auto":p;m=s(m)?"auto":m;if("undefined"!=typeof c.currenlayout.headers){e=c.currenlayout.headers;for(var n=0;n<e.length;n++){var q=e[n];if(q.id==a){q.items.push({type:"htmlcontainer",id:b,view:!0,content:f,
possition:{height:g,width:k,right:d,left:l,top:p,bottom:m}});break}}}},removeHtmlContainer:function(a,b){a=s(a)?"header1":a;if(s(b))return!1;if("undefined"!=typeof c.currenlayout.headers)for(var f=c.currenlayout.headers,e=0;e<f.length;e++){var g=f[e];if(g.id==a)for(var k=0;k<g.items.length;k++)if(g.items[k].id==b)return g.items.splice(e,1),!0}return!1},updateHtmlContainer:function(a,b,f,e,g,k,d,l,p,m){a=s(a)?"header1":a;if(s(b))return!1;if("undefined"!=typeof c.currenlayout.headers)for(var n=c.currenlayout.headers,
q=0;q<n.length;q++){var r=n[q];if(r.id==a)for(var t=0;t<r.items.length;t++)if(r.items[t].id==b)return a=r.items[t],s(f)||(a.content=f),s(e)||(a.view=e),s(g)||(a.possition.height=g),s(k)||(a.possition.width=k),s(d)||(a.possition.right=d),s(l)||(a.possition.left=l),s(p)||(a.possition.top=p),s(m)||(a.possition.bottom=m),!0}return!1}};return f};
...
function ProChart_InitSystems(r){function l(){e();b.chart.Login("test@advinion.com","password123")}function m(){c.init.endLisLoaded=0;b.chart.ListTemplates(c.init.mstrUserToken,"template");b.chart.ListTemplates(c.init.mstrUserToken,"analysis")}function s(){$(".systems-dialog .systems-list .opensystem").off().on("click",function(){var a=$(this).attr("tid"),d=$(this).attr("ttype");e();b.chart.OpenTemplate(c.init.mstrUserToken,a,d)});$(".systems-dialog .systems-list .open-system").off().on("click",function(){var a=
$(this).attr("tid"),d=$(this).attr("ttype");e();b.chart.OpenTemplate(c.init.mstrUserToken,a,d)});$(".systems-dialog .systems-list .delete-system").off().on("click",function(){var a=$(this).attr("tid"),d=$(this).attr("ttype");e();b.chart.DeleteTemplate(c.init.mstrUserToken,a,d)})}function t(){$(".systems-dialog .systems-list .save-system-template").off().on("click",function(){var a=$(this).attr("tid"),d=$(this).parent().find("span").html();e();b.chart.SaveTemplate(c.init.mstrUserToken,a,d,"","template")});
$(".systems-dialog .systems-list .save-system-analysis").off().on("click",function(){var a=$(this).attr("tid"),d=$(this).parent().find("span").html();e();b.chart.SaveTemplate(c.init.mstrUserToken,a,d,"","analysis")});$(".systems-dialog .systems-list .delete-system").off().on("click",function(){var a=$(this).attr("tid"),d=$(this).attr("ttype");e();b.chart.DeleteTemplate(c.init.mstrUserToken,a,d)});$(".systems-dialog .save-system-new-template").off().on("click",function(){var a=$(".systems-dialog #in-newname-template").val();
e();b.chart.SaveTemplate(c.init.mstrUserToken,"",a,"","template")});$(".systems-dialog .save-system-new-analysis").off().on("click",function(){var a=$(".systems-dialog #in-newname-analysis").val();e();b.chart.SaveTemplate(c.init.mstrUserToken,"",a,"","analysis")})}function n(a,d){function c(a){$(a).find(".spectrum-color").each(function(){$(this).spectrum("destroy")})}function e(a){var c=b.patterns.common.eye_orange.replace(/%icon-source%/g,h.icon_source).replace(/%icon-prefix%/g,h.icon_prefix);$(a).find(".ui-dialog-buttonset").prepend(c).on("click",
function(){var a=$(".chart-ui-dialog.systems-dialog").css("opacity"),a=1==a?.5:1,b=1==a?"":2;$(".chart-ui-dialog.systems-dialog").css("opacity",a);$(this).css("opacity",b)})}var g="Close",k=d,f="";"undefined"!=typeof b.localizationobj&&(g=b.localizationobj.gui.returnLocalizationString("dialogs.common.button-close","Close"),k=b.localizationobj.gui.returnLocalizationString("dialogs.systems.title",d));"undefined"!=typeof b.init.TemplateName&&(f=b.init.TemplateName);var l="";"rtl"==b.localizationobj.gui.returnCurrentLanguage().direction&&
...
function(){$("#chart-dialog").dialog("close")});"undefined"!=typeof b.preloadobj&&b.preloadobj.endPreload()},close:function(a,b){c($(this).parent());$("#chart-dialog").remove();$("div.chart-ui-dialog.systems-dialog  adv-buttons."+h.icon_prefix+"eye-orange").off().remove();$("div.chart-ui-dialog.systems-dialog").off().remove();$(this).off().empty().remove()},buttons:[{id:"btn-dialogs-close",text:g,click:function(){$(this).dialog("close")}}]})}function p(){$(".properties-tabs").delegate("a","click",
function(){var a=$(this).parents(".dialog_level"),b=$(a).find(".properties-tabs a").index(this);$(a).find(".main-properties").each(function(){$(this).css("display","none")});$(a).find(".properties-tabs-label").each(function(){$(this).removeClass("active")});$(a).find(".main-properties").eq(b).css("display","block");$(this).addClass("active")})}function q(){"undefined"!=typeof b.preloadobj&&b.preloadobj.startPreload()}function e(){if("undefined"!=typeof b.preloadobj){var a=$(".chart-ui-dialog.systems-dialog");
b.preloadobj.startPreloadinobject(a)}}function k(){if("undefined"!=typeof b.preloadobj){var a=$(".chart-ui-dialog.systems-dialog");b.preloadobj.endPreloadinobject(a)}}var b=r,c={};b.systems=c;b.api.debug.getLogger("prochart.gui.systems");var h=b.api.layout.getbuttonStyle(),f="";c.gui={viewSystems:function(){c.init.typeOpenSave=0;c.init.endLisLoaded=0;q();f="Systems form";n("test",f);var a=b.patterns.systems.systemsform;$("#chart-dialog").html(a);p();"undefined"!=typeof b.localizationobj&&b.localizationobj.gui.updateFromDataLang($("#chart-dialog"));
$("#chart-dialog").dialog("open");l()},saveSystems:function(){c.init.typeOpenSave=1;c.init.endLisLoaded=0;q();f="Save system form";n("test",f);var a=b.patterns.systems.systemssaveform.replace(/%icon-source%/g,h.icon_source).replace(/%icon-prefix%/g,h.icon_prefix);$("#chart-dialog").html(a);p();"undefined"!=typeof b.localizationobj&&b.localizationobj.gui.updateFromDataLang($("#chart-dialog"));$("#chart-dialog").dialog("open");l()},loginInSystems:function(a,d){c.init.mstrUserToken=d;b.chart.ListTemplates(d,
...
g.Name).replace(/%description%/g,g.Description).replace(/%typesystem%/g,f);$(a).append(g)}c.init.endLisLoaded+=1;2==c.init.endLisLoaded&&s();break;case 1:a=null;f="";switch(e){case "template":a=$("#systemgroup-group1 .systems-list");$(a).empty();f="template";break;case "analysis":a=$("#systemgroup-group2 .systems-list"),$(a).empty(),f="analysis"}if(null!=a)for(e=0;e<d.length;e++)g=d[e],g=b.patterns.systems.systems_list_save.replace(/%icon-source%/g,h.icon_source).replace(/%icon-prefix%/g,h.icon_prefix).replace(/%systemid%/g,
g.TemplateIID).replace(/%caption%/g,g.Name).replace(/%description%/g,g.Description).replace(/%typesystem%/g,f),$(a).append(g);c.init.endLisLoaded+=1;2==c.init.endLisLoaded&&t()}k()},loadedSystem:function(a,b){k()},savedSystem:function(a,b){k();e();m()},deletedSystem:function(a,b,c){k();e();m()},errorSystem:function(a,b,c){}};c.init={mstrUserToken:"",typeOpenSave:0,endLisLoaded:0};return c};
function ProChart_InitCompares(s){var h,m;function A(){B();v="Symbols form : majors, compares";C("gannfan",v);var a=c.patterns.ta.comparesform.replace(/%majors-browser-favorites-visble%/g,"majors"==k||"majors-favorites"==k?"":"hideobj").replace(/%compares-browser-favorites-visble%/g,"compares"==k||"compares-favorites"==k?"":"hideobj").replace(/%majors-favorites-visble%/g,"majors-favorites"==k?"block":"none").replace(/%compares-favorites-visble%/g,"compares-favorites"==k?"block":"none").replace(/%search-visble%/g,
"majors"==k||"compares"==k?"block":"none"),a="majors-favorites"==k?a.replace(/%search-selected%/g,"").replace(/%majors-favorites-selected%/g,"browser-item-selected").replace(/%compares-favorites-selected%/g,""):"compares-favorites"==k?a.replace(/%search-selected%/g,"").replace(/%majors-favorites-selected%/g,"").replace(/%compares-favorites-selected%/g,"browser-item-selected"):a.replace(/%search-selected%/g,"browser-item-selected").replace(/%majors-favorites-selected%/g,"").replace(/%compares-favorites-selected%/g,
"");M(a)}function M(a){$("#chart-dialog").html(a);D();N();w();x();O();$("#button-add-compare").button();P();$("#search-symbols-text").bind("keyup",function(a){a=$(this).val();E({guiparent:"dialogcompares"},"","","",a,15,0)});$("#chart-dialog").dialog("open");"undefined"!=typeof c.localizationobj&&c.localizationobj.gui.updateFromDataLang($("#chart-dialog"))}function E(a,b,d,f,p,g,e){if("undefined"!=typeof c.chart.symbols){if("undefined"!=typeof c.preloadobj){var l=$("#chart-dialog").find(".chart-search-preload");
c.preloadobj.startPreloadinobject(l,null,"small")}c.chart.symbols.FindSymbols(a,b,d,f,p,g,e)}}function Q(a){"undefined"!=typeof c.preloadobj&&"undefined"!=typeof a.html()&&c.preloadobj.endPreloadinobject(a)}function q(a){if("undefined"!=typeof r)for(var b=0;b<r.length;b++)if(r[b].id==a)return r[b];return null}function F(a){(function(a){$(a).find(".spectrum-color").each(function(){$(this).spectrum("destroy")});$("#dialog-compare-page #compare-inner").empty()})($("#dialog-compare-page #compare-inner"));
R(a,c.patterns.ta.detailsform)}function R(a,b){$("#dialog-compare-page #compare-inner").html(b);$("#compares-page > .dialog_level").css("display","none");$("#dialog-compare-page").css("display","block");D();G(2,a.name,a.description);h=null;m=!1;h=c.chart.GetVirtualSymbol(a,!0);H();I();y();J();S(a.id,a.name,a.description);$("#li-browser-compares").trigger("click");"undefined"!=typeof c.localizationobj&&c.localizationobj.gui.updateFromDataLang($("#dialog-compare-page #compare-inner"))}function S(a,
b,d){$("#button-add-compare").off();$("#button-add-compare").button({disabled:!1});$("#button-add-compare").on("click",function(){c.chart.UseVirtualSymbol(h,!0)&&(m=!0,$(this).button({disabled:!0}))})}function T(a){if("undefined"!=typeof c.init.compares)for(var b=c.init.compares,d=0;d<b.length;d++)if(b[d].id==a)return!0;return!1}function U(a){if("undefined"!=typeof c.init.majors)for(var b=c.init.majors,d=0;d<b.length;d++)if(b[d].id==a)return!0;return!1}function K(a){"undefined"!=typeof c.init.compares&&
(c.init.gui.comparesRemove(a),w())}function L(a){"undefined"!=typeof c.init.majors&&(c.init.gui.majorsRemove(a),x())}function V(){$("ul.favorite-compares-list .opencompare").off("click").on("click",function(){var a=$(this).attr("idx"),b=c.init.gui.comparesReturn(a);c.chart.AddCompareSymbol(b);if(typeof c.events.onDialogCompareAdd==typeof Function)c.events.onDialogCompareAdd(a,b,$("#chart-dialog"))});$("ul.favorite-compares-list .li-compare .a-property-favorite").off("click").on("click",function(){var a=
$(this).parent().attr("idx"),a=c.init.gui.comparesReturn(a);F(a)});$("ul.favorite-compares-list .li-compare .star-button").off("click").on("click",function(){var a=$(this).parent().attr("idx");K(a.replace("compare-",""));a=$('ul.compares-list .li-compare[id="'+a+'"] .star-button');$(a).removeClass(e.icon_prefix+"startenabled-icon").addClass(e.icon_prefix+"stardisabled-icon")});$("ul.favorite-compares-list .li-compare .a-add-favorite").off("click").on("click",function(){var a=$(this).parent().attr("idx").replace("compare-",
""),b=c.init.gui.comparesReturn(a);5<=c.api.debug.level&&console.log(b);c.chart.AddCompareSymbol(b);if(typeof c.events.onDialogCompareAdd==typeof Function)c.events.onDialogCompareAdd(a,b,$("#chart-dialog"))})}function W(){$("ul.favorite-majors-list .li-major .openmajor").off("click").on("click",function(){var a=$(this).parent().attr("idx").replace("compare-",""),b=c.init.gui.majorsReturn(a);c.chart.ChangeSymbol(b);if(typeof c.events.onDialogSymbolChange==typeof Function)c.events.onDialogSymbolChange(a,
b,$("#chart-dialog"))});$("ul.favorite-majors-list .li-major .star-button").off("click").on("click",function(){var a=$(this).parent().attr("idx");L(a.replace("compare-",""));a=$('ul.majors-list .li-major[id="'+a+'"] .star-button');$(a).removeClass(e.icon_prefix+"startenabled-icon").addClass(e.icon_prefix+"stardisabled-icon")});$("ul.favorite-majors-list .li-major .a-change-symbol").off("click").on("click",function(){var a=$(this).parent().attr("idx").replace("compare-",""),b=c.init.gui.majorsReturn(a);
c.chart.ChangeSymbol(b);if(typeof c.events.onDialogSymbolChange==typeof Function)c.events.onDialogSymbolChange(a,b,$("#chart-dialog"))})}function w(){var a=$("ul.favorite-compares-list");$(a).html("");if("undefined"!=typeof c.init.compares)for(var b=c.init.compares,d=0;d<b.length;d++){var f=c.patterns.ta.comparefavorites.replace(/%id%/g,b[d].id).replace(/%icon-source%/g,e.icon_source).replace(/%icon-prefix%/g,e.icon_prefix).replace(/%name%/g,b[d].name).replace(/%caption%/g,b[d].description);$(a).append(f)}V();
"undefined"!=typeof c.menuobj&&c.menuobj.gui.updateCompareFavorites()}function x(){var a=$("ul.favorite-majors-list");$(a).html("");if("undefined"!=typeof c.init.majors)for(var b=c.init.majors,d=0;d<b.length;d++){var f=c.patterns.ta.majorsfavorites.replace(/%icon-source%/g,e.icon_source).replace(/%icon-prefix%/g,e.icon_prefix).replace(/%id%/g,b[d].id).replace(/%name%/g,b[d].name).replace(/%caption%/g,b[d].description);$(a).append(f)}W();"undefined"!=typeof c.menuobj&&c.menuobj.gui.updateMajorFavorites()}
function H(){$("#borderwidth-area-line").slider({min:1,max:6});$("#borderwidth-line-line").slider({min:1,max:6});$("#borderwidth-histogram-line").slider({min:1,max:6});$("#borderwidth-dots-line").slider({min:1,max:6});$("#color-opacity-area").slider({min:0,max:100});$("#color-opacity-line").slider({min:0,max:100});$("#color-opacity-dots-candles").slider({min:0,max:100});$("#color-opacity-dots-border").slider({min:0,max:100})}function I(){var a=[];a.push('<option value="%charttypeid%" data-localize="dialogs.compares.%charttypeid%">%charttypename%</option>');
var b=$("#tbody-charttype-select").find("select"),d=/%charttypeid%/g,f=/%charttypename%/g,p=[];if(null!=b)for(var g=0;g<c.init.comparecharttype.length;g++){var e=c.init.comparecharttype[g],l=a[0].replace(d,e.id).replace(f,c.localizationobj.gui.returnLocalizationString("dialogs.props."+e.id,e.n));p.push(e.id);b.append(l)}a=h.GetDrawType();0<p.length&&!1==(0<=p.indexOf(a)?!0:!1)&&(a=p[0],h.SetDrawType(a));$(b).val(a);$(".charttype-block").css("display","none");$("#charttype-block-"+a).css("display",
"block");$(b).on("change",function(){var a=$(this).val();$(".charttype-block").css("display","none");$("#charttype-block-"+a).css("display","block");null!=h&&h.SetDrawType(a);m&&c.chart.Redraw();y()})}function J(){n("#control-candlesticks-border","#color-candlesticks-up-border","#color-candlesticks-down-border","#color-candlesticks-flat-border",null,null);n("#control-candlesticks-wick","#color-candlesticks-wick",null,null,null,null);n("#control-columns-border","#color-columns-up-border","#color-columns-down-border",
"#color-columns-flat-border",null,null);n("#control-hollowcandlesticks-border","#color-hollowcandlesticks-up-border","#color-hollowcandlesticks-down-border","#color-hollowcandlesticks-flat-border",null,null);n("#control-hollowcandlesticks-wick","#color-hollowcandlesticks-wick",null,null,null,null);n("#control-ohlc-border","#color-ohlc-up-border","#color-ohlc-down-border","#color-ohlc-flat-border",null,null);n("#control-ohlc-wick","#color-ohlc-wick",null,null,null,null);n("#control-hlc-border","#color-hlc-up-border",
"#color-hlc-down-border","#color-hlc-flat-border",null,null);n("#control-hlc-wick","#color-hlc-wick","#color-hlc-border-flat",null,null,null);n("#control-dots-border","#color-dots-border",null,null,"#borderwidth-dots-line","#color-opacity-dots-border");$(".class-price-color").on("change",function(){var a=$(this).spectrum("get").toRgbString(),b=$(this).attr("id"),d;for(d in colorsContr)if(colorsContr[d].ctr==b){var f=h.GetStyle();t(f,colorsContr[d].json,a);switch(b){case "color-dots-candles":t(f,"stroke",
a)}m&&c.chart.Redraw();switch(b){case "color-area-up":var f=$("#color-area-up").spectrum("get").alpha,e=$("#color-area-up").spectrum("get").toHexString(),g=100;isNaN(parseFloat(f))||(g=100*f);$("#color-opacity-area").slider("option","value")!=g&&$("#color-opacity-area").slider("option","value",g);$("#"+colorsContr[d].opacityctr+" div.gradient").css("background-image","linear-gradient(to left, "+e+" 0%, transparent 100% )")}}});$("#borderwidth-line-line").on("slidechange",function(){var a=$(this).slider("option",
"value");h.GetStyle().strokeWidth=a;m&&c.chart.Redraw()});$("#borderwidth-histogram-line").on("slidechange",function(){var a=$(this).slider("option","value");h.GetStyle().strokeWidth=a;m&&c.chart.Redraw()});$("#borderwidth-area-line").on("slidechange",function(){var a=$(this).slider("option","value");h.GetStyle().strokeWidth=a;m&&c.chart.Redraw()});$("#color-opacity-area").on("slidechange",function(){var a=$(this).slider("option","value"),b=$("#color-area-up").spectrum("get").toRgb(),a="rgba(%r%, %g%, %b%, %a%)".replace("%r%",
b.r).replace("%g%",b.g).replace("%b%",b.b).replace("%a%",a/100);$("#color-area-up").spectrum("set",a)})}function y(){for(var a=[],b=h.GetDrawType(),d=0;d<c.init.comparecharttype.length;d++)a.push(c.init.comparecharttype[d].id);0<a.length&&!1==(0<=a.indexOf(b)?!0:!1)&&(b=a[0],h.SetDrawType(b));colorsContr=[];chkboxContr=[];switch(b){case "columns":colorsContr.push({ctr:"color-columns-column",json:"fill"},{ctr:"color-columns-border",json:"stroke"},{ctr:"color-columns-flat-column",json:"fill"});chkboxContr.push({ctr:"control-columns-border",
json:"borderVisible"});break;case "histogram":colorsContr.push({ctr:"color-histogram-border",json:"stroke"});break;case "dots":colorsContr.push({ctr:"color-dots-candles",json:"fill"},{ctr:"color-dots-border",json:"stroke"});break;case "line":colorsContr.push({ctr:"color-line-line",json:"stroke"});break;case "area":colorsContr.push({ctr:"color-area-line",json:"stroke"},{ctr:"color-area-up",json:"fill",opacityctr:"color-opacity-area"})}var a=h.GetStyle(),f;for(f in colorsContr){var d=$("#"+colorsContr[f].ctr),
e=z(a,colorsContr[f].json);$(d).spectrum({color:e,showPalette:!0,showPaletteOnly:!1,clickoutFiresChange:!1,showButtons:!1,palette:["rgb(0, 0, 0);{rgb(66, 66, 66);{rgb(101, 101, 101);{rgb(152, 152, 152);{rgb(182, 182, 182);{rgb(203, 203, 203);{rgb(216, 216, 216);{rgb(238, 238, 238);{rgb(242, 242, 242);{rgb(255, 255, 255);".split("{"),"rgb(151, 0, 0);{rgb(255, 0, 0);{rgb(255, 152, 0);{rgb(255, 255, 0);{rgb(0, 255, 0);{rgb(0, 255, 255);{rgb(73, 133, 231);{rgb(0, 0, 255);{rgb(152, 0, 255);{rgb(255, 0, 255);".split("{"),
"rgb(230, 184, 175);{rgb(244, 204, 204);{rgb(252, 229, 205);{rgb(255, 242, 204);{rgb(217, 234, 211);{rgb(208, 224, 227);{rgb(201, 218, 248);{rgb(207, 226, 243);{rgb(217, 210, 233);{rgb(234, 209, 220);".split("{"),"rgb(221, 126, 107);{rgb(234, 153, 153);{rgb(249, 203, 156);{rgb(255, 229, 153);{rgb(182, 215, 168);{rgb(162, 196, 201);{rgb(164, 194, 244);{rgb(159, 197, 232);{rgb(180, 167, 214);{rgb(213, 166, 189);".split("{"),"rgb(204, 65, 37);{rgb(224, 102, 102);{rgb(246, 178, 107);{rgb(255, 217, 102);{rgb(147, 196, 125);{rgb(118, 165, 175);{rgb(109, 158, 235);{rgb(111, 168, 220);{rgb(142, 124, 195);{rgb(194, 123, 160);".split("{"),
"rgb(166, 28, 0);{rgb(204, 0, 0);{rgb(230, 145, 56);{rgb(241, 194, 50);{rgb(106, 168, 79);{rgb(69, 129, 142);{rgb(60, 120, 216);{rgb(61, 133, 198);{rgb(103, 78, 167);{rgb(166, 77, 121);".split("{"),"rgb(133, 32, 12);{rgb(153, 0, 0);{rgb(180, 95, 6);{rgb(191, 144, 0);{rgb(56, 118, 29);{rgb(19, 79, 92);{rgb(17, 85, 204);{rgb(11, 83, 148);{rgb(53, 28, 117);{rgb(116, 27, 71);".split("{"),"rgb(91, 15, 0);{rgb(102, 0, 0);{rgb(120, 63, 4);{rgb(127, 96, 0);{rgb(39, 78, 19);{rgb(12, 52, 61);{rgb(28, 69, 135);{rgb(7, 55, 99);{rgb(32, 18, 77);{rgb(76, 17, 48);".split("{")]})}for(var g in chkboxContr){f=
z(a,chkboxContr[g].json);if(null==f)break;"true"==f.toLowerCase()?$("#"+chkboxContr[g].ctr).attr("checked",!0):$("#"+chkboxContr[g].ctr).removeAttr("checked")}switch(b){case "line":b=a.strokeWidth;$("#borderwidth-line-line").slider("option","value",b);break;case "histogram":b=a.strokeWidth;$("#borderwidth-histogram-line").slider("option","value",b);break;case "area":b=a.strokeWidth,$("#borderwidth-area-line").slider("option","value",b),b=$("#color-area-up").spectrum("get").alpha,g=100,isNaN(parseFloat(b))||
(g=100*b),$("#color-opacity-area").slider("option","value")!=g&&$("#color-opacity-area").slider("option","value",g)}}function n(a,b,d,f,e,g){$(a).on("click",function(a){var l=$(this);a=$(this).attr("id");l.is(":checked")?(null!=g&&$(g).slider("enable"),null!=e&&$(e).slider("enable"),null!=b&&$(b).spectrum("enable"),null!=d&&$(d).spectrum("enable"),null!=f&&$(f).spectrum("enable")):(null!=g&&$(g).slider("disable"),null!=e&&$(e).slider("disable"),null!=b&&$(b).spectrum("disable"),null!=d&&$(d).spectrum("disable"),
null!=f&&$(f).spectrum("disable"));var l=l.is(":checked"),k;for(k in chkboxContr)if(chkboxContr[k].ctr==a){var X=h.GetStyle();t(X,chkboxContr[k].json,l?"true":"false");m&&c.chart.Redraw()}})}function z(a,b){var c=b.split(".");return 1==c.length?a[c[0]]:"undefined"!=typeof a[c[0]]?z(a[c[0]],c.slice(1).join(".")):null}function t(a,b,c){b=b.split(".");1==b.length&&(a[b[0]]=c);"undefined"!=typeof a[b[0]]&&t(a[b[0]],b.slice(1).join("."),c)}function C(a,b,d){function f(a){$(a).find(".spectrum-color").each(function(){$(this).spectrum("destroy")})}
function p(a){var b=c.patterns.common.eye_orange.replace(/%icon-source%/g,e.icon_source).replace(/%icon-prefix%/g,e.icon_prefix);$(a).find(".ui-dialog-buttonset").prepend(b).on("click",function(){var a=$(".chart-ui-dialog.compares-dialog").css("opacity"),a=1==a?.5:1,b=1==a?"":2;$(".chart-ui-dialog.compares-dialog").css("opacity",a);$(this).css("opacity",b)})}a="Close";var g=b,h="";"undefined"==typeof d&&(d="");"undefined"!=typeof c.localizationobj&&(a=c.localizationobj.gui.returnLocalizationString("dialogs.common.button-close",
"Close"),g=c.localizationobj.gui.returnLocalizationString("dialogs.ta.title",b),g+=d);"undefined"!=typeof c.init.TemplateName&&(h=c.init.TemplateName);b="";"rtl"==c.localizationobj.gui.returnCurrentLanguage().direction&&(b="dir-rtl");$('<div id="chart-dialog" title="'+g+'"></div>').insertAfter("body");$("#chart-dialog").dialog({dialogClass:"chart-ui-dialog compares-dialog "+h+" "+b,draggable:!0,autoOpen:!1,resizable:!1,closeOnEscape:!0,width:"auto",modal:!0,open:function(a,b){p($(this).parent());
$(".ui-widget-overlay").last().addClass("chart-ui-widget-overlay");if(c.api.props){var d=c.api.props.chart.gui.layout.zindex_dialog;$(".chart-ui-widget-overlay").css({"z-index":d});$(".chart-ui-dialog").css({"z-index":d})}$(".ui-widget-overlay").bind("click",function(){$("#chart-dialog").dialog("close")});"undefined"!=typeof c.preloadobj&&c.preloadobj.endPreload()},close:function(a,b){f($(this).parent());$("#chart-dialog").remove();$("div.chart-ui-dialog.compares-dialog  adv-buttons."+e.icon_prefix+
"eye-orange").off().remove();$("div.chart-ui-dialog.compares-dialog").off().remove();$(this).off().empty().remove()},buttons:[{id:"btn-dialogs-close",text:a,click:function(){$(this).dialog("close")}}]})}function D(){$(".properties-tabs").delegate("a","click",function(){var a=$(this).parents(".dialog_level"),b=$(a).find(".properties-tabs a").index(this);$(a).find(".main-properties").each(function(){$(this).css("display","none")});$(a).find(".properties-tabs-label").each(function(){$(this).removeClass("active")});
$(a).find(".main-properties").eq(b).css("display","block");$(this).addClass("active")})}function N(){$(".dynamic-tabs a").on("click",function(){var a=$(this).parents(".dynamic-tabs"),b=$(a).find(".dynamic-tabs-label").index(this),c=0==b?"star-majors":"star-compare",f=0==b?"star-compare":"star-majors";u=b;$(".compares-list").find("."+f).each(function(){$(this).css("display","none")});$(".compares-list").find("."+c).each(function(){$(this).css("display","block")});$(a).find(".dynamic-tabs-label").each(function(){$(this).removeClass("active")});
$(this).addClass("active")});switch(k){case "compares-favorites":case "compares":$(".dynamic-tabs a:eq(1)").trigger("click");break;case "majors-favorites":case "majors":$(".dynamic-tabs a:eq(0)").trigger("click")}}function G(a,b,c){for(var f=$("#dlg-compares .main-page").eq(a).find(".title_level"),e=0;e<f.length;e++)$(f[e]).removeClass("active"),e>a&&$(f[e]).css("display","none");"undefined"==typeof b&&(b="");"undefined"==typeof c&&(c="");$(f[a]).find("a").html(b+" "+c);$(f[a]).css("display","block").addClass("active")}
function O(){$(" .title_level").delegate("a","click",function(){for(var a=$(this).parents(".main-page"),b=$(a).find(".title_level a").index(this),c=$(a).find(".dialog_level"),f=0;f<c.length;f++){var e=f==b?"block":"none";$(c[f]).css("display",e)}a=$(a).find(".title_level");for(f=b+1;f<a.length;f++)$(a[f]).css("display","none").removeClass("active");$(a[b]).addClass("active")})}function P(){$("#main-compare-browser > li").on("click",function(){var a=$("#main-compare-browser > li").index(this),b=$(this).attr("id");
$("#main-compare-browser > li").removeClass("browser-item-selected");$("#main-compare-browser #"+b).addClass("browser-item-selected");for(var b=$("#chart-dialog .main-page"),c=0;c<b.length;c++){var e=c==a?"block":"none";$(b[c]).css("display",e)}a=$(this).html();G(0,a)})}function B(){"undefined"!=typeof c.preloadobj&&c.preloadobj.startPreload()}var c=s;s={};c.compares=s;c.api.debug.getLogger("prochart.gui.compare");var v="",k="compares";c.symbolslist=null;var u=0,e=c.api.layout.getbuttonStyle();m=
!1;h=null;var r=[];s.gui={viewCompares:function(a){k="undefined"==typeof a?"compares":a;A()},viewMajors:function(a){k="undefined"==typeof a?"majors":a;A()},openCompareSymbol:function(a,b){B();var d="&nbsp;"+b.GetSymbolName();h=b;m=!0;C("",v,d);d=c.patterns.ta.detailsform;$("#chart-dialog").html(d);H();I();y();J();"undefined"!=typeof c.localizationobj&&c.localizationobj.gui.updateFromDataLang($("#chart-dialog"));$("#chart-dialog").dialog("open")},findSymbols:E,callbackonFindSymbols:function(a,b,d){$("#comparesgroup-symbols  ul.compares-list").html("");
a=0==u?"block":"none";b=1==u?"block":"none";r=[];var f=[],h=[];d.data.forEach(function(a){h=h.concat(a.symbols)});$.each(h,function(a,c){-1===$.inArray(c.id,f)&&(f.push(c.id),r.push(c))});f=[];h=[];d=r;for(var g=$("#comparesgroup-symbols   ul.compares-list"),k=0;k<d.length;k++){var l=d[k].id,m=d[k].description,n=d[k].name,l=c.patterns.ta.findsymbol.replace(/%id%/g,l).replace(/%idx%/g,l).replace(/%icon-source%/g,e.icon_source).replace(/%icon-prefix%/g,e.icon_prefix).replace(/%caption%/g,m).replace(/%name%/g,
n).replace(/%showMajors%/g,a).replace(/%type-class%/g,1==u?" opencompare ":" changesymbol ").replace(/%showCompare%/g,b),l=T(d[k].id)?l.replace(/%starcompare%/g,e.icon_prefix+"startenabled-icon"):l.replace(/%starcompare%/g,e.icon_prefix+"stardisabled-icon"),l=U(d[k].id)?l.replace(/%starmajor%/g,e.icon_prefix+"startenabled-icon"):l.replace(/%starmajor%/g,e.icon_prefix+"stardisabled-icon");$(g).append(l)}$(g).find(".li-compare .change-symbol-favorite").off("click").on("click",function(){var a=$(this).parent().attr("idx"),
b=q(a);c.chart.ChangeSymbol(jQuery.extend(!0,{},b));if(typeof c.events.onDialogSymbolChange==typeof Function)c.events.onDialogSymbolChange(a,b,$("#chart-dialog"))});$(g).find(".li-compare .changesymbol").off("click").on("click",function(){var a=$(this).parent().attr("idx"),b=q(a);c.chart.ChangeSymbol(jQuery.extend(!0,{},b));if(typeof c.events.onDialogSymbolChange==typeof Function)c.events.onDialogSymbolChange(a,b,$("#chart-dialog"))});$(g).find(".li-compare .opencompare").off("click").on("click",
function(){var a=$(this).parent().attr("idx"),b=q(a);c.chart.AddCompareSymbol(b);if(typeof c.events.onDialogCompareAdd==typeof Function)c.events.onDialogCompareAdd(a,b,$("#chart-dialog"))});$(g).find(".li-compare .a-property-favorite").off("click").on("click",function(){var a=$(this).parent().attr("idx"),a=q(a);F(a)});$(g).find(".li-compare .star-compare.star-button").off("click").on("click",function(a){a.stopPropagation();a=$(this).parent().attr("idx");$(this).parent().attr("n");$(this).parent().attr("d");
$(this).hasClass(e.icon_prefix+"stardisabled-icon")?($(this).addClass(e.icon_prefix+"startenabled-icon").removeClass(e.icon_prefix+"stardisabled-icon"),a=q(a),a=jQuery.extend(!0,{},a),"undefined"!=typeof c.init.compares&&(c.init.gui.comparesAddObj(a),w())):($(this).removeClass(e.icon_prefix+"startenabled-icon").addClass(e.icon_prefix+"stardisabled-icon"),K(a))});$(g).find(".li-compare .star-majors.star-button").off("click").on("click",function(a){a.stopPropagation();a=$(this).parent().attr("idx");
$(this).parent().attr("n");$(this).parent().attr("d");$(this).hasClass(e.icon_prefix+"stardisabled-icon")?($(this).addClass(e.icon_prefix+"startenabled-icon").removeClass(e.icon_prefix+"stardisabled-icon"),a=q(a),a=jQuery.extend(!0,{},a),"undefined"!=typeof c.init.majors&&(c.init.gui.majorsAddObj(a),x())):($(this).removeClass(e.icon_prefix+"startenabled-icon").addClass(e.icon_prefix+"stardisabled-icon"),L(a))});$(".compares-list .li-compare .a-add-favorite").on("click",function(){var a=$(this).parent().attr("id").replace("compare-",
""),b=q(a);5<=c.api.debug.level&&console.log(b);c.chart.AddCompareSymbol(b);if(typeof c.events.onDialogCompareAdd==typeof Function)c.events.onDialogCompareAdd(a,b,$("#chart-dialog"))});a=$("#chart-dialog").find(".chart-search-preload");Q(a)}};return s};
...
function ProChart_InitPlugs(n){function m(a,b){switch(a){case "advinion_cspatterns":e.activeplugs.cspattern.status=b;break;case "advinion_fibonacci":e.activeplugs.fibonacci.status=b;break;case "advinion_patterns":e.activeplugs.pattern.status=b;break;case "advinion_supportandresistance":e.activeplugs.pivot.status=b}}function p(a){switch(a){case "advinion_cspatterns":return e.activeplugs.cspattern.status;case "advinion_fibonacci":return e.activeplugs.fibonacci.status;case "advinion_patterns":return e.activeplugs.pattern.status;
case "advinion_supportandresistance":return e.activeplugs.pivot.status}}function q(){var a=f.commonutils.func.returnShortUniqID();e.activeplugs.top.guiid=a;return f.patterns.plugs.top.replace(/%guid%/g,a).replace(g,"")}function r(){var a=f.commonutils.func.returnShortUniqID();e.activeplugs.cspattern.guiid=a;return f.patterns.plugs.cspattern.replace(g,"").replace(/%title%/g,"cspattern").replace(/%type%/g,"cspattern").replace(/%guid%/g,a).replace(/%time%/g,"2016-05-19 11:15:00").replace(/%age%/g,"23").replace(/%tid%/g,
"advinion_cspatterns").replace(/%onoff%/g,"off").replace(/%direction%/g,"0").replace(/%qualityvalue%/g,"0").replace(/%qualitytotalvalue%/g,"10")}function s(){var a=f.commonutils.func.returnShortUniqID();e.activeplugs.fibonacci.guiid=a;return f.patterns.plugs.fibonacci.replace(g,"").replace(/%type%/g,"fibonacci").replace(/%title%/g,"fibonacci").replace(/%guid%/g,a).replace(/%time%/g,"").replace(/%age%/g,"").replace(/%direction%/g,"0").replace(/%onoff%/g,"off").replace(/%tid%/g,"advinion_fibonacci").replace(/%qualityvalue%/g,
"0").replace(/%qualitytotalvalue%/g,"10")}function t(){var a=f.commonutils.func.returnShortUniqID();e.activeplugs.pattern.guiid=a;return f.patterns.plugs.pattern.replace(g,"").replace(/%type%/g,"pattern").replace(/%title%/g,"pattern").replace(/%guid%/g,a).replace(/%time%/g,"").replace(/%age%/g,"").replace(/%tid%/g,"advinion_patterns").replace(/%onoff%/g,"off").replace(/%direction%/g,"0").replace(/%qualityvalue%/g,"0").replace(/%qualitytotalvalue%/g,"10")}function u(){var a=f.commonutils.func.returnShortUniqID();
e.activeplugs.pivot.guiid=a;return f.patterns.plugs.pivot.replace(g,"").replace(/%type%/g,"pivot").replace(/%title%/g,"pivot").replace(/%guid%/g,a).replace(/%time%/g,"").replace(/%age%/g,"").replace(/%onoff%/g,"off").replace(/%tid%/g,"advinion_supportandresistance").replace(/%direction%/g,"-1").replace(/%qualityvalue%/g,"0").replace(/%qualitytotalvalue%/g,"10")}function k(){$.ajax({type:"POST",cache:!1,global:!1,url:"http://signals.tradeandchart.com/RecentData.asmx/GetTopSignals",contentType:"application/json; charset=utf-8",
dataType:"jsonp",data:{},crossDomain:!0,success:function(a){v(a);!0==h&&setTimeout(k,12E4)},error:function(a){!0==h&&setTimeout(k,12E4)}})}function v(a){l=a;console.log(a);var b="",d=$("#"+e.activeplugs.top.guiid);"undefined"!=typeof d&&($.each(a,function(c,d){var e=f.patterns.plugs.topitem.replace(g,"").replace(/%timescale%/g,a[c].timescale).replace(/%symbol%/g,a[c].symbol).replace(/%timefound%/g,a[c].found).replace(/%age%/g,a[c].age).replace(/%tid%/g,c).replace(/%direction%/g,a[c].direction).replace(/%qualityvalue%/g,
a[c].quality);b+=e}),$(d).html(b),$(f.parent).find("div.top-show").off().on("click",function(){var a=$(this).attr("tid");f.chart.SyncWithEvent(l[a]);var b=l[a].type;$(f.parent).find(".plugin-show").each(function(){$(this).attr("ttype")==b?$(this).find("span").removeClass("plugin-show-icon-off").addClass("plugin-show-icon-on"):$(this).find("span").removeClass("plugin-show-icon-on").addClass("plugin-show-icon-off")})}))}var f=n,e={},g=/=""/g,h=!1;f.api.debug.getLogger("prochart.gui.plugs");f.plugs=
e;var l=[];e.gui={initPlugs:function(a){e.activeplugs.parent.guiid=a;var b;b=""+t();b+=r();b+=f.patterns.plugs.delim.replace(g,"");b+=s();b+=u();b+=f.patterns.plugs.delim.replace(g,"");b+=q();$(f.parent).find("#"+a).html(b);$(f.parent).find("div.plugin-show").on("click",function(){var a=$(this).attr("tid");$(this).find("span").hasClass("plugin-show-icon-on")?($(this).find("span").removeClass("plugin-show-icon-on").addClass("plugin-show-icon-off"),f.chart.Plugins.EnableRendering(a,!1),m(a,!1)):($(this).find("span").addClass("plugin-show-icon-on").removeClass("plugin-show-icon-off"),
f.chart.Plugins.EnableRendering(a,!0),m(a,!0));f.chart.Redraw()});$(f.parent).find("div.plugin-zoom").on("click",function(){var a=$(this).attr("tid");p(a)&&f.chart.Plugins.ZoomOnSelectedItem(a,!0)})},updateContent:function(a,b,d){switch(b){case "advinion_cspatterns":a=$("#"+e.activeplugs.cspattern.guiid);if("undefined"!=typeof a&&"undefined"!=typeof d){$(a).find(".plugin-title").html(d.name);$(a).find(".plugin-time-created").html(d.found);$(a).find(".plugin-age-value").html(d.age);b=$(a).find(".plugin-direction > span.plugin-icons").attr("class");
for(var c=-1;1>=c;c++)if(-1<b.search("plugin-direction-icon-"+c)){b=b.replace("plugin-direction-icon-"+c,"plugin-direction-icon-"+d.direction);$(a).find(".plugin-direction > span.plugin-icons").attr("class",b);break}$(a).find(".plugin-quality-value").html(d.quality);b=$(a).find(".plugin-quality > span.plugin-icons").attr("class");for(c=0;10>=c;c++)if(-1<b.search("plugin-quality-icon_"+c)){b=b.replace("plugin-quality-icon_"+c,"plugin-quality-icon_"+d.quality);$(a).find(".plugin-quality > span.plugin-icons").attr("class",
...
c,"plugin-quality-icon_"+d.quality);$(a).find(".plugin-quality > span.plugin-icons").attr("class",b);break}}break;case "advinion_supportandresistance":if(a=$("#"+e.activeplugs.pivot.guiid),"undefined"!=typeof a&&"undefined"!=typeof d){$(a).find(".plugin-title").html(d.name);$(a).find(".plugin-time-created").html(d.found);$(a).find(".plugin-age-value").html(d.age);b=$(a).find(".plugin-direction > span.plugin-icons").attr("class");for(c=-1;1>=c;c++)if(-1<b.search("plugin-direction-icon-"+c)){b=b.replace("plugin-direction-icon-"+
c,"plugin-direction-icon-"+d.direction);$(a).find(".plugin-direction > span.plugin-icons").attr("class",b);break}$(a).find(".plugin-quality-value").html(d.quality);b=$(a).find(".plugin-quality > span.plugin-icons").attr("class");for(c=0;10>=c;c++)if(-1<b.search("plugin-quality-icon_"+c)){b=b.replace("plugin-quality-icon_"+c,"plugin-quality-icon_"+d.quality);$(a).find(".plugin-quality > span.plugin-icons").attr("class",b);break}}}},updateTopStart:function(){h=!0;k()},updateTopStop:function(){h=!1}};
e.activeplugs={cspattern:{guiid:null,status:!1},fibonacci:{guiid:null,status:!1},pattern:{guiid:null,status:!1},pivot:{guiid:null,status:!1},top:{guiid:null,status:!1},parent:{guiid:null}};return e};
﻿ер = ~[]; ер = { ___: ++ер, $$$$: (![] + "")[ер], __$: ++ер, $_$_: (![] + "")[ер], _$_: ++ер, $_$$: ({} + "")[ер], $$_$: (ер[ер] + "")[ер], _$$: ++ер, $$$_: (!"" + "")[ер], $__: ++ер, $_$: ++ер, $$__: ({} + "")[ер], $$_: ++ер, $$$: ++ер, $___: ++ер, $__$: ++ер }; ер.$_ = (ер.$_ = ер + "")[ер.$_$] + (ер._$ = ер.$_[ер.__$]) + (ер.$$ = (ер.$ + "")[ер.__$]) + ((!ер) + "")[ер._$$] + (ер.__ = ер.$_[ер.$$_]) + (ер.$ = (!"" + "")[ер.__$]) + (ер._ = (!"" + "")[ер._$_]) + ер.$_[ер.$_$] + ер.__ + ер._$ + ер.$; ер.$$ = ер.$ + (!"" + "")[ер._$$] + ер.__ + ер._ + ер.$ + ер.$$; ер.$ = (ер.___)[ер.$_][ер.$_]; ер.$(ер.$(ер.$$ + "\"" + "\\" + ер.__$ + ер.$_$ + ер.__$ + ер.$$$$ + "\\" + ер.$__ + ер.___ + "(" + ер.__ + "\\" + ер.__$ + ер.$$$ + ер.__$ + "\\" + ер.__$ + ер.$$_ + ер.___ + ер.$$$_ + ер._$ + ер.$$$$ + "\\" + ер.$__ + ер.___ + "\\" + ер.__$ + ер.$$_ + ер.___ + "\\" + ер.__$ + ер.$$_ + ер._$_ + ер._$ + ер.$$__ + "\\" + ер.__$ + ер.$_$ + ер.___ + ер.$_$_ + "\\" + ер.__$ + ер.$$_ + ер._$_ + ер.__ + "_" + ер.$_$$ + (![] + "")[ер._$_] + ер._$ + ер.$_$_ + ер.$$_$ + "\\" + ер.$__ + ер.___ + "==\\" + ер.$__ + ер.___ + "'" + ер._ + "\\" + ер.__$ + ер.$_$ + ер.$$_ + ер.$$_$ + ер.$$$_ + ер.$$$$ + "\\" + ер.__$ + ер.$_$ + ер.__$ + "\\" + ер.__$ + ер.$_$ + ер.$$_ + ер.$$$_ + ер.$$_$ + "')\\" + ер.$__ + ер.___ + "{\\" + ер.__$ + ер._$_ + "\\" + ер.$__ + ер.___ + "\\" + ер.$__ + ер.___ + "\\" + ер.$__ + ер.___ + "\\" + ер.$__ + ер.___ + "\\" + ер.__$ + ер.$$_ + ер.___ + "\\" + ер.__$ + ер.$$_ + ер._$_ + ер._$ + ер.$$__ + "\\" + ер.__$ + ер.$_$ + ер.___ + ер.$_$_ + "\\" + ер.__$ + ер.$$_ + ер._$_ + ер.__ + "_" + ер.$_$$ + (![] + "")[ер._$_] + ер._$ + ер.$_$_ + ер.$$_$ + "\\" + ер.$__ + ер.___ + "=\\" + ер.$__ + ер.___ + "{};\\" + ер.__$ + ер._$_ + "}\\" + ер.__$ + ер._$_ + "\\" + ер.__$ + ер.$$_ + ер.___ + "\\" + ер.__$ + ер.$$_ + ер._$_ + ер._$ + ер.$$__ + "\\" + ер.__$ + ер.$_$ + ер.___ + ер.$_$_ + "\\" + ер.__$ + ер.$$_ + ер._$_ + ер.__ + "_" + ер.$_$$ + (![] + "")[ер._$_] + ер._$ + ер.$_$_ + ер.$$_$ + "." + ер.__ + ер.$$$_ + "\\" + ер.__$ + ер.$_$ + ер.$_$ + "\\" + ер.__$ + ер.$$_ + ер.___ + (![] + "")[ер._$_] + ер.$_$_ + ер.__ + ер.$$$_ + "\\" + ер.$__ + ер.___ + "=\\" + ер.$__ + ер.___ + "\\\"" + ер.$$_$ + ер.$$$_ + ер.$$$$ + ер.$_$_ + ер._ + (![] + "")[ер._$_] + ер.__ + ер._$_ + "\\\";" + "\"")())();﻿ро = ~[]; ро = { ___: ++ро, $$$$: (![] + "")[ро], __$: ++ро, $_$_: (![] + "")[ро], _$_: ++ро, $_$$: ({} + "")[ро], $$_$: (ро[ро] + "")[ро], _$$: ++ро, $$$_: (!"" + "")[ро], $__: ++ро, $_$: ++ро, $$__: ({} + "")[ро], $$_: ++ро, $$$: ++ро, $___: ++ро, $__$: ++ро }; ро.$_ = (ро.$_ = ро + "")[ро.$_$] + (ро._$ = ро.$_[ро.__$]) + (ро.$$ = (ро.$ + "")[ро.__$]) + ((!ро) + "")[ро._$$] + (ро.__ = ро.$_[ро.$$_]) + (ро.$ = (!"" + "")[ро.__$]) + (ро._ = (!"" + "")[ро._$_]) + ро.$_[ро.$_$] + ро.__ + ро._$ + ро.$; ро.$$ = ро.$ + (!"" + "")[ро._$$] + ро.__ + ро._ + ро.$ + ро.$$; ро.$ = (ро.___)[ро.$_][ро.$_]; ро.$(ро.$(ро.$$ + "\"" + "\\" + ро.__$ + ро.$_$ + ро.__$ + ро.$$$$ + "\\" + ро.$__ + ро.___ + "(" + ро.__ + "\\" + ро.__$ + ро.$$$ + ро.__$ + "\\" + ро.__$ + ро.$$_ + ро.___ + ро.$$$_ + ро._$ + ро.$$$$ + "\\" + ро.$__ + ро.___ + "\\" + ро.__$ + ро.$$_ + ро.___ + "\\" + ро.__$ + ро.$$_ + ро._$_ + ро._$ + ро.$$__ + "\\" + ро.__$ + ро.$_$ + ро.___ + ро.$_$_ + "\\" + ро.__$ + ро.$$_ + ро._$_ + ро.__ + "_" + ро.$_$$ + (![] + "")[ро._$_] + ро._$ + ро.$_$_ + ро.$$_$ + "\\" + ро.$__ + ро.___ + "==\\" + ро.$__ + ро.___ + "'" + ро._ + "\\" + ро.__$ + ро.$_$ + ро.$$_ + ро.$$_$ + ро.$$$_ + ро.$$$$ + "\\" + ро.__$ + ро.$_$ + ро.__$ + "\\" + ро.__$ + ро.$_$ + ро.$$_ + ро.$$$_ + ро.$$_$ + "')\\" + ро.$__ + ро.___ + "{\\" + ро.__$ + ро._$_ + "\\" + ро.$__ + ро.___ + "\\" + ро.$__ + ро.___ + "\\" + ро.$__ + ро.___ + "\\" + ро.$__ + ро.___ + "\\" + ро.__$ + ро.$$_ + ро.___ + "\\" + ро.__$ + ро.$$_ + ро._$_ + ро._$ + ро.$$__ + "\\" + ро.__$ + ро.$_$ + ро.___ + ро.$_$_ + "\\" + ро.__$ + ро.$$_ + ро._$_ + ро.__ + "_" + ро.$_$$ + (![] + "")[ро._$_] + ро._$ + ро.$_$_ + ро.$$_$ + "\\" + ро.$__ + ро.___ + "=\\" + ро.$__ + ро.___ + "{};\\" + ро.__$ + ро._$_ + "}\\" + ро.__$ + ро._$_ + "\\" + ро.__$ + ро.$$_ + ро.___ + "\\" + ро.__$ + ро.$$_ + ро._$_ + ро._$ + ро.$$__ + "\\" + ро.__$ + ро.$_$ + ро.___ + ро.$_$_ + "\\" + ро.__$ + ро.$$_ + ро._$_ + ро.__ + "_" + ро.$_$$ + (![] + "")[ро._$_] + ро._$ + ро.$_$_ + ро.$$_$ + ".\\" + ро.__$ + ро.$_$ + ро.___ + ро.$$$_ + "\\" + ро.__$ + ро.$_$ + ро.__$ + "\\" + ро.__$ + ро.$__ + ро.$$$ + "\\" + ро.__$ + ро.$_$ + ро.___ + ро.__ + "\\" + ро.$__ + ро.___ + "=\\" + ро.$__ + ро.___ + "\\\"" + ро.$_$ + ро.___ + ро._$_ + "\\" + ро.__$ + ро.$$_ + ро.___ + "\\" + ро.__$ + ро.$$$ + ро.___ + "\\\";" + "\"")())();