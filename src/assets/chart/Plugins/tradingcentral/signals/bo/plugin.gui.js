function ProChart_Init_plugin_tradingcentral_bo(chartObject) {
    ...
    function contentUpdateLegend(obj, objsettings) {
        ...
        $('#' + objPlugin.panel.panelObject.main.guiid).find('.tradingcentral-bo-legend').html(legend);

        // background

        var bk = objChartMain.commonutils.func.valueForKey(objsettings, 'legendBKColor');
        if (bk != null) {
            $('#' + objPlugin.panel.panelObject.main.guiid).find('.tradingcentral-bo-legend').css('background-color', bk);
        }
    ...
    function contentUpdateStory(obj, objsettings) {
        ...
        $('#' + objPlugin.panel.panelObject.main.guiid).find('.tradingcentral-bo-story').html(story);

        // background

        var bk = objChartMain.commonutils.func.valueForKey(objsettings, 'storyBKColor');
        if (bk != null) {
            $('#' + objPlugin.panel.panelObject.main.guiid).find('.tradingcentral-bo-story').css('background-color', bk);
        }
    ...
    function contentUpdateError(obj) {
        ...
        $('#' + objPlugin.panel.panelObject.main.guiid).find('.tradingcentral-bo-error').html(error);
    ...
    function createPanel() {
        ...
        $('#' + objPlugin.panel.panelObject.main.guiid).load(objChartMain.guiinit.rootpath + "/" + objPlugin.info.path + 'panel.htm' + updatetime + ' #gui-panel', function () {
            ...
            var title = objChartMain.localizationobj.gui.returnLocalizationString(objPlugin.info.id + ".title", 'Trading Central Binary Option');
    ...
    function onResizePanel(objPanel) {
        ...
        // change resize
        $('#' + objPlugin.panel.panelObject.main.guiid).find('.tradingcentral-bo').css('height', objPlugin.panel.panelObject.main.height);
    ...
    function startWaitSignal() {
        ...
        if (typeof objChartMain.preloadobj != 'undefined') {
            var parpreload = $('#' + objPlugin.panel.panelObject.main.guiid).find('#tradingcentrallbo-waiting-forsignal');
